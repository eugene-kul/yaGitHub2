...
try {
    ...
    $mail->Username   = 'svai-novosibirsk@yandex.ru';                     // SMTP username
    $mail->Password   = 'kHVKyznzVH';                               // SMTP password
    $mail->SMTPSecure = 'ssl';                                  // Enable TLS encryption, `ssl` also accepted
    $mail->Port       = 465;                                    // TCP port to connect to
    $mail->CharSet    = 'utf-8';

    //Recipients
    $mail->setFrom('svai-novosibirsk@yandex.ru', 'Сваи НОВОСИБИРСК Заявка');
    $mail->addAddress('svai-novosibirsk@yandex.ru', 'Сваи НОВОСИБИРСК Заявка');
